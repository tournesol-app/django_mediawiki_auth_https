<?php
/* AuthHttpsDjango.php. Based on https://github.com/mpetroff/django-mediawiki-authentication/blob/master/AuthDjango.body.php */

use MediaWiki\Auth\AuthManager;

require_once('https_django_auth.php');
...
class AuthHttpsDjangoPlugin extends PluggableAuth {
...
public static function onBeforeInitialize( \Title &$title, $unused, \OutputPage $output, \User $user, \WebRequest $request, \MediaWiki $mediaWiki) {
	...
	$wgPluggableAuth_Class = 'AuthHttpsDjangoPlugin';
}
}
?>
